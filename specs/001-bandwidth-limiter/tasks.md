...
- [ ] T012 [P] Créer `.github/workflows/integration.yml` : exécution des tests d'intégration sur une **VM de la matrice de compatibilité** — c'est la porte de fusion n° 3 de la constitution, aujourd'hui sans automatisation
- [ ] T013 [P] Créer `README.md` avec la matrice de compatibilité de plan.md et `THIRD-PARTY-NOTICES.md` contenant le texte de licence LGPL v3 de WinDivert
